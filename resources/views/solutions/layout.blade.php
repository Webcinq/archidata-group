{{-- resources/views/solutions/layout.blade.php --}}
@extends('layout')
        ...
        <div class="hero-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    <li class="breadcrumb-item"><a href="{{ route('index') }}" class="text-light">Accueil</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('service') }}" class="text-light">Solutions</a></li>
