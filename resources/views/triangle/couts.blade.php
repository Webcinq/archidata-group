@extends('triangle.layout')

@section('hero_image', '/img/maitrise-des-couts-BIM-management.png')
@section('triangle_title', 'Maîtrise des Coûts')
@section('triangle_subtitle', 'Suivi quantitatif rigoureux et gestion budgétaire précise.')

@section('triangle_content')
<style>
