...
@section('hero_image', '/img/new/maitrise-des-delais-BIM-managment.jpg')
@section('triangle_title', 'Maîtrise des Délais')
@section('triangle_subtitle', 'Simulations BIM avancées et planification optimisée')
