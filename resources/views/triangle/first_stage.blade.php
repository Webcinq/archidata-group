...
@section('hero_image', 'img/new/tr.avif')
@section('triangle_title', 'Transparence')
@section('triangle_subtitle', 'Communication claire et gestion fluide des données projet')
